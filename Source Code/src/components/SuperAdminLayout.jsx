...
export default function SuperAdminLayout({ children }) {
  ...
  const links = [
    ...
    { name: "Identity Directory", path: "/super-admin/users", icon: "👥" },
    { name: "System Streams", path: "/super-admin/system-logs", icon: "📝" },
    { name: "Security Center", path: "/super-admin/security", icon: "🛡️" },
    { name: "Global Settings", path: "/super-admin/settings", icon: "⚙️" },
    { name: "Database Ops", path: "/super-admin/database", icon: "🗄️" },
    { name: "Access Controls", path: "/super-admin/roles", icon: "🎭" },
  ];
      ...
      >
        ...
        <div className="h-20 flex items-center px-6 border-b border-slate-50 dark:border-dark-800 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-purple-600 rounded-2xl shadow-xl shadow-purple-500/20 flex items-center justify-center text-white font-black text-sm italic">
              AC
            </div>
